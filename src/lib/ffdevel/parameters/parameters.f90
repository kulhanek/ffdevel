...
subroutine ffdev_parameters_init()
    ...
    maxnparams = maxnparams + 4 ! sq+s6+bj_a+bj_b
...
integer function ffdev_parameters_get_realmid(realm)
    ...
    select case(trim(realm))
        ...
        case('vdw_c6')
            ffdev_parameters_get_realmid = REALM_VDW_C6
...
real(DEVDP) function ffdev_params_get_lower_bound(realm)
    ...
    select case(realm)
        ...
        case(REALM_VDW_C6)
            ffdev_params_get_lower_bound = MinVdwC6
...
real(DEVDP) function ffdev_params_get_upper_bound(realm)
    ...
    select case(realm)
        ...
        case(REALM_VDW_C6)
            ffdev_params_get_upper_bound = MaxVdwC6
