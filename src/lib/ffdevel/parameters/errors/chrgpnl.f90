...
! ==============================================================================
! subroutine ffdev_err_chrgpnl_init
! ==============================================================================
...
subroutine ffdev_err_chrgpnl_init
    ...
    EnableChrgPnlError        = .false.
    PrintChrgPnlErrorSummary  = .false.
    ChrgPnlErrorWeight        = 1.0
    ChrgPnlFce                = CHRG_PNL_QUADRATIC

end subroutine ffdev_err_chrgpnl_init

! ==============================================================================
! subroutine ffdev_err_chrgpnl_error
! ==============================================================================

subroutine ffdev_err_chrgpnl_error(error)
    ...
    do i=1,nsets
        do j=1,sets(i)%ngeos
            ...
            do k=1,sets(i)%top%natoms
                select case(ChrgPnlFce)
                    case(CHRG_PNL_QUADRATIC)
                        diff = sets(i)%geo(j)%sup_chrg(k) - sets(i)%top%atoms(k)%charge
                        error%chrgpnl = error%chrgpnl + diff**2
                    case default
                        call ffdev_utils_exit(DEV_ERR,1,'Not implemented in ffdev_err_chrgpnl_error!')
                end select
            end do
        end do
    end do

end subroutine ffdev_err_chrgpnl_error

! ==============================================================================
! subroutine ffdev_err_chrgpnl_summary
! ==============================================================================

subroutine ffdev_err_chrgpnl_summary(top,geo,printsum)
    ...
    write(DEV_OUT,45) totpnl*ChrgPnlErrorWeight
...
end subroutine ffdev_err_chrgpnl_summary

! ------------------------------------------------------------------------------

end module ffdev_err_chrgpnl
