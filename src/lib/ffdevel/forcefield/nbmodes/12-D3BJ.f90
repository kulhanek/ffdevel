...
subroutine ffdev_energy_nb_12_D3BJ(top,geo)
    ...
    real(DEVDP)     :: V_aa,V_bb,r6i,r8i,pe
    ! --------------------------------------------------------------------------
    ...
    do ip=1,top%nb_size
        ...
        pe = (1.0d0 - exp(-disp_fc*r/mmd3_pairs(agti,agtj)%rc))
...
!===============================================================================
! subroutine ffdev_energy_sapt_12_D3BJ
!===============================================================================

subroutine ffdev_energy_sapt_12_D3BJ(top,geo)
    ...
    if( .not. mmd3_data_loaded ) then
        call ffdev_utils_exit(DEV_ERR,1,'MMD3 not loaded for ffdev_energy_sapt_12_D3BJ!')
    end if
...
end subroutine ffdev_energy_sapt_12_D3BJ
