...
!===============================================================================
! subroutine ffdev_energy_nb_EXP_D3BJ
!===============================================================================

subroutine ffdev_energy_nb_EXP_D3BJ(top,geo)
    ...
    do ip=1,top%nb_size
        ...
        rc  = damp_fa * xdm_pairs(agti,agtj)%rc + damp_fb
        ...
        pe = (1.0d0 - exp(-pene_fa*r/xdm_pairs(agti,agtj)%rc))
...
end subroutine ffdev_energy_nb_EXP_D3BJ

!===============================================================================
! subroutine ffdev_energy_sapt_EXP_D3BJ
!===============================================================================

subroutine ffdev_energy_sapt_EXP_D3BJ(top,geo)
...
end subroutine ffdev_energy_sapt_EXP_D3BJ

! ------------------------------------------------------------------------------

end module ffdev_nbmode_EXP_D3BJ
