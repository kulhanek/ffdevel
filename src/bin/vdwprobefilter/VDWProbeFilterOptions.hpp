#ifndef VDWProbeFilterOptionsH
#define VDWProbeFilterOptionsH
// =============================================================================
...
class CVDWProbeFilterOptions : public CSimpleOptions {
public:
    // constructor - tune option setup
    CVDWProbeFilterOptions(void);
...
// program name and description -----------------------------------------------
    ...
    CSO_PROG_DESC_BEGIN
    "Create multiple-xyz file containing the structure and probe from the structure and vertices of MSMS surface."
    CSO_PROG_DESC_END
...
// list of all options and arguments ------------------------------------------
    ...
    CSO_ARG(CSmallString,ProbesName)
...
// description of arguments ---------------------------------------------------
    ...
    CSO_MAP_ARG(CSmallString,                   /* argument type */
                ProbesName,                          /* argument name */
                NULL,                           /* default value */
                true,                           /* is argument mandatory */
                "PROBES",                           /* parametr name */
                "Vertices of MSMS surface defining possible location of probes.")   /* argument description */
    CSO_MAP_ARG(CSmallString,                   /* argument type */
...
// description of options -----------------------------------------------------
    ...
    CSO_MAP_OPT(CSmallString,                           /* option type */
                ...
                "NAME",                           /* parametr name */
                "filter mode: minmax, random")   /* option description */
    CSO_MAP_OPT(int,                           /* option type */
                ...
                "NUM",                           /* parametr name */
                "number of generated probes (valid for random mode); zero means number of atoms in the structure")   /* option description */
    CSO_MAP_OPT(CSmallString,                           /* option type */
