...
character(len=MAX_PATH) :: ProfileName  = 'profile.dat'     ! CVs Energy
...
logical         :: HoldCV           = .false.   ! keep rotor CV constant during point optimization
...
! ai0, and aj0 are autogenerated

type ROTOR
    integer     :: ait
    integer     :: ai       ! ai,aj - atoms defining rotor
    integer     :: aj
    integer     :: ajt      ! ait,ai,aj,ajt - atoms defining torsion
    real(DEVDP) :: angle
end type ROTOR
